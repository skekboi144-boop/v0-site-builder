...
const SERVICES = [
  ...
  },
  {
    ...
    title: 'Landscaping',
    desc: 'Transform your outdoor space with expert landscape design, planting, and maintenance services.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <nav className="fixed top-0 w-full bg-slate-950/90 backdrop-blur-md border-b border-white/10 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/logo.png" alt="L&L Contracting Group" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
